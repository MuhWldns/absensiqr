        ...
        <div class='col-xs-12'>
            <div class='box box-<?=$box?>'>
                <div class='box-header  with-border'>
                    <h3 class='box-title'>NPSN</h3>
                </div>
                <div class="box-body">
                    <form role="form" id="myForm" data-toggle="validator" action="<?php echo $action; ?>" method="post">
                        <div class="form-group has-feedback">
                            <label for="nama_shift" class="label-control">NPSN <?php echo form_error('nama_shift') ?></label>
                            <div class="input-group">
                                <input type="text" class="form-control" data-error="Nama Shift harus diisi" name="nama_shift" id="nama_shift" placeholder="NPSN" value="<?php echo $nama_shift; ?>" required />
