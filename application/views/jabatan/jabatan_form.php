        ...
        <div class='col-xs-12'>
            <div class='box box-<?=$box?>'>
                <div class='box-header  with-border'>
                    <h3 class='box-title'>KELAS DAN JURUSAN</h3>
                </div>
                <div class="box-body">
                    <form role="form" id="myForm" data-toggle="validator" action="<?php echo $action; ?>" method="post">
                        <div class="form-group has-feedback">
                            <label for="nama_jabatan"> Kelas & Jurusan <?php echo form_error('nama_jabatan') ?></label>
                            <div class="input-group">
                                <input type="text" class="form-control" data-error="Nama Jabatan harus diisi" name="nama_jabatan" id="nama_jabatan" placeholder="Kelas & Jurusan" value="<?php echo $nama_jabatan; ?>" required />
